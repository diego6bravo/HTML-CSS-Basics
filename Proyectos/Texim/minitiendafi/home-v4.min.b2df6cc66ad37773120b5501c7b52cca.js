...
}n.find(".hero-carousel__product__img").css({top:s+"vw",maxWidth:i+"%"})
}}})
}$(".hero-carousel__slide a,.hero-carousel__slide button").attr("tabindex","-1");
$(".hero-carousel__slide.swiper-slide-active a,.hero-carousel__slide.swiper-slide-active button").attr("tabindex","0")
});
...
dmpaCommon("trackEvent","click","banner interaction",j,"");
...
$(".hero-carousel-prev").click(function(){var d=getRealIndex("left");
var b=$(".hero-carousel .swiper-wrapper").children().eq(d).attr("data-slidename");
var g=getLastIndex(d);
var c=$(".hero-carousel .swiper-wrapper").children().eq(g).attr("data-slidename");
var f={event:"bannerClick",nextBannerName:c,previousBannerName:b,buttonName:"left arrow",bannerPosition:d};
window.dataLayer.push(f);
var a="hero_carousel_component";
var e=a+"_"+b;
dmpaCommon("trackEvent","click","banner interaction",e,"left arrow")
});
$(".hero-carousel-next").click(function(){var e=getRealIndex("right");
var c=$(".hero-carousel .swiper-wrapper").children().eq(e).attr("data-slidename");
var a=getNextIndex(e);
var d=$(".hero-carousel .swiper-wrapper").children().eq(a).attr("data-slidename");
var g={event:"bannerClick",nextBannerName:d,previousBannerName:c,buttonName:"right arrow",bannerPosition:e};
window.dataLayer.push(g);
var b="hero_carousel_component";
var f=b+"_"+d;
dmpaCommon("trackEvent","click","banner interaction",f,"right arrow")
});
...
var e=$(".product-carousel__products").find(".product-carousel__product").eq(this.previousIndex).find(".product-carousel__img").attr("data-alt");
if($(window).width()<1200&&c.swiperGaFlag){var f={event:"bannerSwipe",nextBannerName:this.$wrapperEl.find(".swiper-slide-active").find(".product-carousel__img").attr("data-alt"),previousBannerName:e,bannerPosition:"product_carousel_"+(parseInt(this.activeIndex)+1),swipeDirection:this.previousIndex<this.activeIndex?"left":"right",clickName:"banner swipe "+(this.previousIndex<this.activeIndex?"left":"right")+" to "+(this.$wrapperEl.find(".swiper-slide-active").find(".product-carousel__img").attr("data-alt")),clickType:"action"};
window.dataLayer.push(addATCommonFields(f));
var d=(this.previousIndex<this.activeIndex?"left":"right")+"_"+this.$wrapperEl.find(".swiper-slide-active").find(".product-carousel__img").attr("data-alt");
dmpaCommon("trackEvent","click","banner interaction",d,"")
}c.swiperGaFlag=true
}}});
$(window).scroll(function(){var e=$(".p05-product-carousel").offset().top;
var f=$(window).scrollTop();
if(e-f<window.innerHeight&&c.initSwiperFlag){c.initSwiperFlag=false;
if(b.length){for(var d=0;
d<b.length;
d++){b.init()
}}else{b.init()
}}});
$(c.categoryBtn).on("click",function(){var f=$(".product-carousel__products").find(".swiper-slide-active").find(".product-carousel__img").attr("data-alt");
var d=$(this).index();
b.slideTo(d);
$(c.categories).each(function(){$(this).find("."+c.categoryBtnActive).removeClass(c.categoryBtnActive);
$(this).find(c.categoryBtn).eq(d).addClass(c.categoryBtnActive)
});
var h={event:"bannerClick",nextBannerName:$(".product-carousel__products").find(".swiper-slide-active").find(".product-carousel__img").attr("data-alt"),previousBannerName:f,buttonName:$(this).text().trim(),bannerPosition:"product_carousel_"+(parseInt(d)+1),clickName:"banner click "+($(this).text().trim())+" to "+($(".product-carousel__products").find(".swiper-slide-active").find(".product-carousel__img").attr("data-alt")),clickType:"action"};
window.dataLayer.push(addATCommonFields(h));
var e=$(this).text().trim();
var g=$(".product-carousel__products").find(".swiper-slide-active").find(".product-carousel__img").attr("data-alt");
dmpaCommon("trackEvent","click","banner interaction",e,g);
c.swiperGaFlag=false
});
$(".p05-product-carousel .product-carousel__arrow").on("click",function(){var g=$(this).index();
var f=$(".product-carousel__products").find(".product-carousel__product").index($(".product-carousel__products").find(".swiper-slide-active"));
var d=$(this).closest(".product-carousel__products").find(".swiper-slide-prev").find(".product-carousel__img").attr("data-alt");
var h=$(this).closest(".product-carousel__products").find(".swiper-slide-next").find(".product-carousel__img").attr("data-alt");
var j={event:"bannerClick",nextBannerName:$(this).closest(".product-carousel__products").find(".swiper-slide-active").find(".product-carousel__img").attr("data-alt"),previousBannerName:g==0?d:h,buttonName:g==0?"right arrow":"left arrow",bannerPosition:"product_carousel_"+(parseInt(f)+1),clickName:"banner click "+(g==0?"right arrow":"left arrow")+" to "+($(this).closest(".product-carousel__products").find(".swiper-slide-active").find(".product-carousel__img").attr("data-alt")),clickType:"action"};
window.dataLayer.push(addATCommonFields(j));
var e=g==0?"right arrow":"left arrow";
var i=$(this).closest(".product-carousel__products").find(".swiper-slide-active").find(".product-carousel__img").attr("data-alt");
dmpaCommon("trackEvent","click","banner interaction",e,i);
c.swiperGaFlag=false
});
